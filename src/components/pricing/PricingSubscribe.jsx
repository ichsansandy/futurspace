      ...
      <div className="flex flex-col gap-[60px] max-w-[1100px] web:items-center">
        ...
        <div className="flex flex-col items-center gap-4 max-w-[650px] w-full">
          <div className="relative w-full">
            ...
            />
            <button type="button" className="hidden min-[362px]:block h-fit text-white absolute right-2 bottom-0 top-0 my-auto bg-primary px-10 py-4 rounded-[50px]">
              Submit
            </button>
            <button type="button" className="min-[362px]:hidden text-white absolute right-0 bottom-[50%] bg-primary px-10 py-4 rounded-[50px]">
              <AiOutlineEnter />
            </button>
          </div>
