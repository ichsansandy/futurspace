...
export default function PricingContact() {
  return (
    <div className="py-[60px]">
      <div className="p-[60px] flex flex-col gap-[21.3px] bg-secondary rounded-xl web:flex-row web:justify-between">
        <div className="hidden web:flex flex-col gap-9 items-start justify-center">
          ...
          <button className="px-10 py-5 transition-all hover:scale-125 bg-primary text-white rounded-[50px]">Contact Us</button>
        </div>
        <div className="relative group max-w-[428px]">
          <img
            ...
            src={contact}
          />
          <button className="absolute text-white m-auto left-0 right-0 top-0 bottom-0 bg-primary/40 flex justify-center items-center text-[12px] sm:text-[20px] w-[12%] aspect-square rounded-full group-hover:scale-150 transition-all">
            <HiPlay />
          </button>
        </div>
